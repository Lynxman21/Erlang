...
-export([create_monitor/0,add_station/3,add_value/5,remove_value/4,get_one_value/4,get_station_min/3,get_daily_mean/3,get_minimum_pollution_station/2,is_station_present/2]).
...
is_station_present(Name,Monitor) ->
...
add_station(Station_name,{Lat,Lon} = Cords,Monitor) ->
  case {is_float(Lat), is_float(Lon)} of
    {true,true} ->

...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
add_value_fail_test() ->
  M0 = pollution:add_station("Stacja 1", {1,1}, pollution:create_monitor()),
  Time = calendar:local_time(),
  M = pollution:add_value("Stacja 1", Time, "PM10", 46.3, M0),
...
get_minimum_pollution_station_test() ->
  M = pollution:add_station("Stacja 1", {1,1}, pollution:create_monitor()),
  Time = calendar:local_time(),
  M1 = pollution:add_station("Stacja 2", {2,1},M),
  M2 = pollution:add_value("Stacja 1",Time,"PM10",10,M1),
  M3 = pollution:add_value("Stacja 2",Time,"PM10",20,M2),
  ?assertMatch("Stacja 1",pollution:get_minimum_pollution_station("PM10",M3)).